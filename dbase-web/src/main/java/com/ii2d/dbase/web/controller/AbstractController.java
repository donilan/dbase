...
public abstract class AbstractController {
	...
	public String create(ModelMap model) throws InstantiationException,
	...
	public @ResponseBody
	String delete(@PathVariable java.lang.Integer id, ModelMap model) {
		int count = getCommonService().delete(id, getInstanceClass());
