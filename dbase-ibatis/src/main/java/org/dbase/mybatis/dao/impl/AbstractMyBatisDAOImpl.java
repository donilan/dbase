...
import org.dbase.mybatis.dao.BaseMyBatisDAO;
...
public abstract class AbstractMyBatisDAOImpl implements BaseMyBatisDAO {
	...
	public int insert(Object o) {
		return sqlSession.insert(_getSqlMapId(METHOD_INSERT, o.getClass()), o);
	}

	@Override
	public int update(Object o) {
		return sqlSession.update(_getSqlMapId(METHOD_UPDATE, o.getClass()), o);
	}

	@Override
	public int delete(Object o) {
		return sqlSession.update(_getSqlMapId(METHOD_DELETE, o.getClass()), o);
	}

	@Override
	public <T> List<T> queryForList(Object o) {
		return queryForList(_getSqlMapId(METHOD_SELECT, o.getClass()), o);
	}

	@Override
	public <T> List<T> queryForList(Object o, int page, int rows) {
		return queryForList(_getSqlMapId(METHOD_SELECT, o.getClass()), o, page, rows);
	}
	...
	public Long count(Object o) {
		return (Long)sqlSession.selectOne(_getSqlMapId(METHOD_COUNT, o.getClass()), o);
	}

	@SuppressWarnings("unchecked")
	@Override
	public <T> List<T> queryForList(String sqlMapId, Object o) {
		return (List<T>) sqlSession.selectList(_getSqlMapId(METHOD_SELECT, o.getClass()), o);
	}
	...
	public <T> List<T> queryForList(String sqlMapId, Object o, int page,
		...
		return sqlSession.selectList(_getSqlMapId(METHOD_LIMIT_SELECT, o.getClass()), sMap);
	}
	 ...
	 * @author Doni
	 * @since 2012-9-9
	 * @param method - sql map method
	 * @param clazz - class
	 * @return example insert_Object
	 */
	protected String _getSqlMapId(String method, Class<?> clazz) {
		if(clazz == null || Object.class.equals(clazz)) {
			throw new RuntimeException("Object cann't be null or clazz cann't be object class.");
		}
